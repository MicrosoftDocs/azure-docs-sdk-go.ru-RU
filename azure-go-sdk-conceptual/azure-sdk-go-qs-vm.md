...
Чтобы войти в систему не в интерактивном режиме с помощью приложения, вам понадобится субъект-служба. Субъекты-службы помогают выполнять аутентификацию на основе ролей, что предусматривает создание уникальных удостоверений пользователя. Чтобы создать субъект-службу с помощью CLI, выполните следующую команду:
...
* `vm_password` — пароль для учетной записи пользователя виртуальной машины. Пароль должен содержать от 6 до 72 символов, включая следующие 3 символа:
  * строчная буква;
  * прописная буква;
  * число;
  * символ.
