...
Аутентификация на основе файла работает с учетными данными клиента, только если они хранятся в формате локального файла, созданного с помощью [Azure CLI](/cli/azure). Этот файл можно легко создать при создании субъекта-службы с использованием параметра `--sdk-auth`. Если вы планируете применить аутентификацию на основе файлов, убедитесь, что этот аргумент задан при создании субъекта-службы. Так как CLI выводит выходные данные в `stdout`, перенаправьте их в файл.
